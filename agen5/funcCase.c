 ...
 *  desc:
 *
 *  The arguments are evaluated and converted to a string, if
 *  necessary.  The scope of the macro is up to the next _ESAC.
 *  Within the scope of a CASE, this string is matched against case
 *  element macros.  There are sixteen match macros that are derived
 *  from four different ways the test may be performed.  The code for
 *  each is formed as follows:
 *
 *  @enumerate
 *  @item
