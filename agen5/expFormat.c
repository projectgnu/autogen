...
/*
 *  expFormat.c
 *  $Id: expFormat.c,v 1.22 2000/09/16 07:18:24 bkorb Exp $
...
"%2$sARE DISCLAIMED.  IN NO EVENT SHALL THE %3$s OR ANY OTHER CONTRIBUTORS\n"
...
"%1$s -*- buffer-read-only: t -*- vi: set ro:\n"
"%1$s\n"
