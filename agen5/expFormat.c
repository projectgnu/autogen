 ...
 *  expFormat.c
 *
 *  Time-stamp:        "2009-07-31 11:39:26 bkorb"
 *  Last Committed:    $Date: 2009/07/31 18:45:17 $
 *
 *  $Id: expFormat.c,v 4.26 2009/07/31 18:45:17 bkorb Exp $
...
"%1$s\n"
"%1$sIt has been AutoGen-ed  %3$s by AutoGen %7$s\n"
...
{
    static char const * agver = AUTOGEN_VERSION;
    ...
    if (noDate) {
        ...
        strftime(zScribble, (size_t)SCRIBBLE_SIZE, "%B %e, %Y at %r",
                 pTime);
    }

    {
        ...
        pzRes = aprf( ENABLED_OPT( WRITABLE ) ? zDne2 : zDne,
                      ...
                      pz, pzTemplFileName, pzFirst, agver );
    }
