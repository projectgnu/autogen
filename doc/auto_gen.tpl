...
## ---------------------------------------------------------------------
## $Id: auto_gen.tpl,v 2.12 1999/02/26 23:09:01 bkorb Exp $
## ---------------------------------------------------------------------
##
texi=autogen.texi =]
\input texinfo
...
contain compound definitions.  Any such definitions may
@strong{only} be expanded within the a @code{FOR} block iterating over
the containing compound definition.  @xref{FOR}.
