...
#  $Id: auto_gen.tpl,v 1.6 1998/07/14 13:35:10 bkorb Exp $
#
texi=autogen.texi =]
\input texinfo
@c %**start of header
...
* Autoopts::             Automatic Option Processing
...
@node Autoopts
@chapter Automatic Option Processing
@cindex autoopts

@code{Autogen} comes with option processing code generated by
@code{autoopts}.  Autoopts is an @code{autogen} template and
a C library which, when combined with a program specific option
definitions file, generates C code to be compiled and linked into an
