...
## ---------------------------------------------------------------------
## $Id: auto_gen.tpl,v 2.38 1999/10/31 22:38:16 bruce Exp $
## ---------------------------------------------------------------------
##
texi=autogen.texi =]
\input texinfo
...
start marker to the end marker constitutes the macro text.
AutoGen macros may cause sections of the template to be skipped
or repeated.  The process continues until the end of the template
is reached.  The process is also repeated once for each suffix
specified in the pseudo macro.
