...
static const char zLongUsageFunc[] =
    "#  From the %s option definitions\n\n"
    "LONGUSAGE()\n{\n    ${PAGER-more} >&2 <<'__USAGE__EOF__'\n";
static const char zUsageFunc[] =
    "__USAGE__EOF__\n    exit 0\n}\n\n"
    "USAGE()\n{\n    cat <<'__USAGE__EOF__'\n";
