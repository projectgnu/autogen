...
#ID:  $Id: options_h.tpl,v 3.3 2002/04/14 20:48:23 bkorb Exp $
 ...
 */
#define  OPTIONS_STRUCT_VERSION  49155
...
[=(prefix " *  " (get "doc"))=][=
   ...
   IF (exist? "private") =]
 *
 *  This routine should only be called by code generated by AutoOpts.
