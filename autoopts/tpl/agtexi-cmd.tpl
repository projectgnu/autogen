...
#
# Time-stamp:        "2012-01-29 12:27:49 bkorb"
...
(out-pop)
(if (exist? "explain") (emit (get "explain")))
...
FOR doc-section                         =][=
  ...
  IF  (define opt-name (string-capitalize! (get "ds-type")))
      (set! tmp-str (sprintf doc-desc-fmt down-prog-name opt-name sub-level))
...
# END-INSTALL-ONLY-CODE =][=
  ...
  (define do-top-menu    #f)
  (if (and (== usage-nodes "documentation")
           (exist? "flag.documentation"))
      (set! do-top-menu #t)
      (if (== usage-nodes "each")
          (set! do-top-menu #t)
          (set! do-top-menu (exist? "doc-section"))
  )   )
