...
##
## Time-stamp:      "2005-10-28 16:19:20 bkorb"
## Maintainer:      Bruce Korb <bkorb@gnu.org>
## Created:         Aug 20, 2002
##              by: bkorb
## ---------------------------------------------------------------------
## $Id: mklibsrc.sh,v 4.22 2005/10/28 23:19:58 bkorb Exp $
## ---------------------------------------------------------------------
## Code:
...
cd ../compat
cp compat.h pathfind.c snprintf.c strdup.c ${top_builddir}/pkg/${tag}/compat/.
