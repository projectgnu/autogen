...
DESCRIPTION:
Bit map manager
Create a header file that enumerates a bit mask and, optionally,
a source file that will convert between strings and the bit masks.
...
YOU SUPPLY:
   ...
   stdint-hdr   the name of the header to include for intNN_t typedefs.
